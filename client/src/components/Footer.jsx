  ...
  return (
    <footer className="bg-primary py-8 text-center text-slate text-sm font-mono">
      <div className="flex justify-center space-x-6 mb-4">
        ...
        <a href="https://www.linkedin.com/in/pallavii-" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors"><Linkedin size={20} /></a>
        <a href="mailto:jainpallavi.delhi@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors"><Mail size={20} /></a>
      </div>
